    ...
    <section id="features" className="py-20 px-6">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          >
            <h3 className="text-lg font-bold text-gray-900 mb-4">Research & Analysis</h3>
          ...
          <motion.div
            ...
            className="text-center bg-white rounded-2xl p-8 shadow-md border border-gray-100"
          >
            <h3 className="text-lg font-bold text-gray-900 mb-4">Development & Automation</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <motion.div
            ...
            className="text-center bg-white rounded-2xl p-8 shadow-md border border-gray-100"
          >
            <h3 className="text-lg font-bold text-gray-900 mb-4">Content & Media</h3>
            <p className="text-gray-600 leading-relaxed">
